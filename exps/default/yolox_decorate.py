...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = 'datasets/decorate_seg/dataset'
        self.random_dataset = {'cate_ls': ['door', 'window', 'wire-box', 'electric-box'],
                               'mask_order': ['door', 'window', 'electric-box', 'wire-box'],
                               'cate_id': {'door': 10, 'window': 20, 'wire-box': 30, 'electric-box': 50},
                               'total': 30000}
