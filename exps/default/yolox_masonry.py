...
class Exp(MyExp):
    def __init__(self):
        ...
        self.random_dataset = {'cate_ls': ['door', 'window', 'wire-box', 'brick-wall', 'electric-box', 'wallboard', 'tilt-brick'],
                               'mask_order': ['brick-wall', 'wallboard', 'tilt-brick', 'door', 'window', 'electric-box', 'wire-box'],
                               'cate_id': {'door': 10, 'window': 20, 'wire-box': 30, 'brick-wall': 40, 'electric-box': 50, 'wallboard': 60, 'tilt-brick': 70},
                               'total': 30000}
