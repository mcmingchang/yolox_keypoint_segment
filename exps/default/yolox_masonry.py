...
class Exp(MyExp):
    def __init__(self):
        ...
        self.multiscale_range = 2  # 0  随机变化的尺度 320:5  32*5~32*15
        self.hsv_prob = 0
        ...
        self.random_dataset = {
            'cate_ls': ['door', 'window', 'wire-box', 'brick-wall', 'electric-box', 'wallboard', 'tilt-brick', 'fence'],
            'mask_order': ['brick-wall', 'wallboard', 'tilt-brick', 'door', 'window', 'fence', 'electric-box', 'wire-box'],
            'cate_id': {'door': 10, 'window': 20, 'wire-box': 30, 'brick-wall': 40, 'electric-box': 50, 'wallboard': 60,
                        'tilt-brick': 70, 'fence': 80},
            'total': 30000}
        self.num_classes = len(self.random_dataset['cate_ls'])
